        ...
        <>
            <Flex marginX="100px"
                ...
                <Flex width="100%" justifyContent="center" gap="50px">
                    ...
                    <PreviewArticle title="Para que serve o create-react-app? (CRA)?" resume="O create-react-app é um conjunto de ferramentas e funcionalidades pré-configuradas para que você possa iniciar" href="/catalog/articles/article2"></PreviewArticle>
